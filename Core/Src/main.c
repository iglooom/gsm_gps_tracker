...
const osThreadAttr_t checksTask_attributes = {
  .name = "checksTask",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityBelowNormal,
};
...
int main(void)
{
  ...
  /* Create the thread(s) */
  /* creation of trackerTask */
  trackerTaskHandle = osThreadNew(TrackerMainTask, NULL, &trackerTask_attributes);

  /* creation of statusTask */
  statusTaskHandle = osThreadNew(TrackerStatusTask, NULL, &statusTask_attributes);

  /* creation of checksTask */
  checksTaskHandle = osThreadNew(PeriodicCheckTask, NULL, &checksTask_attributes);
...
/* USER CODE BEGIN Header_TrackerMainTask */
/**
  * @brief  Function implementing the trackerTask thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_TrackerMainTask */
__weak void TrackerMainTask(void *argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
  for(;;)
